<?php
    ...
    $info_card = [
        ...
        ['titulo' => 'Refund', 'img'=> './img/image.png', 'descricao' => 'Um sistema para pedido e acompanhamento de reembolso '],
        ['titulo' => 'Página de turismo', 'img'=> './img/image.png', 'descricao' => 'Página com as principais informações para quem quer viajar para Busan'],
        ['titulo' => 'Zingen', 'img'=> './img/image.png', 'descricao' => 'Landing Page completa e responsiva de um aplicativo de Karaokê'],
    ];

?>

<section class="bg-[url(./img/Background_Intro.png)] bg-cover bg-center bg-mist-900 h-fit py-24 flex flex-col items-center justify-center gap-16">
    ...
    <div class="w-full h-1/2 grid grid-cols-2 gap-4 items-center justify-items-center">
        ...
        <?php foreach($info_card as $card): ?>
            <div class="w-2/3 h-54 bg-gray-800 flex justify-center rounded-xl">
